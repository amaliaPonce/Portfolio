...
const Data = ({ isDarkTheme }) => {
  ...
  const homeDataClass = `home__data ${isDarkTheme ? "dark-theme" : ""}`;
  ...
  return (
    <div className={homeDataClass}>
      ...
      <a href="https://www.linkedin.com/in/amaliadivinaponcetoledo/" className={buttonClasses}>
  <span>{t("home.sendMailButton")}</span>
  <svg
